              ...
              <div key={request._id} className="request-card">
                <h2>
                  {properties[request.property_id]
                    ? properties[request.property_id].name
                ...
                {properties[request.property_id] && (
                  <div className="property-details">
                    ...
                    <p>Area: {properties[request.property_id].area} </p>
                    <p>Bedrooms: {properties[request.property_id].bedrooms}</p>
                    <p>
                      Bathrooms: {properties[request.property_id].bathrooms}
                    </p>
                    <p>
                      Nearby Hospitals:{" "}
                      {properties[request.property_id].hospitals}
                    </p>
                    <p>
                      Nearby Colleges:{" "}
                      {properties[request.property_id].colleges}
                    </p>
                  </div>
                )}
