...
const getProperty = asyncHandler(async (req, res) => {
  ...
  const likesProperty = asyncHandler(async (req, res) => {
    try {
      const property = await Property.findById(req.params.id);
      if (!property) {
  ...
  module.exports = {getLandlordProperties, getAllProperties, createProperty, getProperty, updateProperty, deleteProperty,getTenantProperties, likesProperty}